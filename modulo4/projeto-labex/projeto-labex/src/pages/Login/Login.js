...
import galaxiaB from '../Login/img/galaxiaB.png';
...
const ButtonDiv = styled.div`
    ...
    margin-top: 20px;
`
const ImgGalaxiaB = styled.img`
    width: 100%;
    height: auto;
`
const urlLogin = "https://us-central1-labenu-apis.cloudfunctions.net/labeX/well-sotero-guimaraes/login";
